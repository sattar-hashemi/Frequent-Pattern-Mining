...
% Below is the main streamwise feature selection (SFS) code. 
% It uses two helper functions, Linear_Regression and Prediction_Error 
% the main function, Alpha_Investing 

 function [w,model] =Alpha_Investing(X, y)
...
%   accuracy=(1-Prediction_Error(X, y, w)/n)*100;
%   disp(accuracy);
